...
import { getFriendlyAuthError, signUpWithEmail } from '../firebase/authService';
...
const SignupPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    signUpWithEmail({ email, password, displayName })
      .then(() => {
        // Navigate after successful signup/login.
        navigate('/avatar');
      })
      .catch((err) => {
        setErrors((prev) => ({
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Create your account and start learning about human rights.</p>
        </div>
